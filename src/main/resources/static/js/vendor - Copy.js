function getJson() {
	var $items = $('#vendorName, #vendorCompanyRegistrationNo, #vendorType, #vendorAddress, #country, #state, #vendorEmail, #vendorContact, #vendorWebsite, #vendorCertificateIssuedDate, #vendorCertificateValidityDate, #vendorEmployeesCount, #vendorCustomerCount, #vendorYearOfEstablishment');
	var obj = {};
	$items.each(function() {
